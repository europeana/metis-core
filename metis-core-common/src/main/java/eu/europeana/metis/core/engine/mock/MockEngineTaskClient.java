...
public class MockEngineTaskClient implements EngineTaskClient<MockEngineTaskSettings, MockEngineTask> {
  ...
  @Override
  public String submitEngineTask(MockEngineTask engineTask, String topologyName) throws ExternalTaskException {
    try {
  ...
  @Override
  public EngineTaskProgress getEngineTaskProgress(String topologyName, String taskId) throws ExternalTaskException {
    try {
