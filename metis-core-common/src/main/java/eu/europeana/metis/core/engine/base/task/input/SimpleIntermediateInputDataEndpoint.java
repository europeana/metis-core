 ...
 * intermediate data processing where a source execution is associated with the input data and no other specific parameters are
 * required.
 *
 ...
 */
public record SimpleIntermediateInputDataEndpoint(String sourceExecutionId, String sourceBatchId) implements
