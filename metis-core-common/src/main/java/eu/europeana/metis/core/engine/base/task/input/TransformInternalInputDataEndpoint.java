...
/**
 * Represents an intermediate input data endpoint that applies an XSLT transformation to internal data before it is processed
 * further.
 *
...
public record TransformInternalInputDataEndpoint(String xslt, String url, String sourceExecutionId, String sourceBatchId)
