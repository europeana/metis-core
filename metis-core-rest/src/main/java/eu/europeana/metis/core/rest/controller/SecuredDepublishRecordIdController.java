...
public class SecuredDepublishRecordIdController {

  private static final Logger LOGGER = LoggerFactory.getLogger(SecuredDepublishRecordIdController.class);
   ...
   */
  @Autowired
  public SecuredDepublishRecordIdController(SecuredDepublishRecordIdService securedDepublishRecordIdService) {
